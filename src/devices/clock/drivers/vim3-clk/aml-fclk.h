...
#ifndef SRC_DEVICES_CLOCK_DRIVERS_VIM3_CLK_AML_FCLK_H_
#define SRC_DEVICES_CLOCK_DRIVERS_VIM3_CLK_AML_FCLK_H_
...
#endif  // SRC_DEVICES_CLOCK_DRIVERS_VIM3_CLK_AML_FCLK_H_
