...
#ifndef SRC_GRAPHICS_DISPLAY_DRIVERS_AMLOGIC_DISPLAY_PANEL_BOE_TV070WSM_FITIPOWER_JD9364_ASTRO_H_
#define SRC_GRAPHICS_DISPLAY_DRIVERS_AMLOGIC_DISPLAY_PANEL_BOE_TV070WSM_FITIPOWER_JD9364_ASTRO_H_
...
constexpr uint8_t lcd_init_sequence_BOE_TV070WSM_FITIPOWER_JD9364_ASTRO[] = {
    ...
    // analog voltage input (VCI) is 144 timing clocks, i.e. 144 * 4 = 576
    // oscillator periods.
    ...
    //
    // Sets STV_S0[10:0] to 0x006.
    // Sets the initial phase of the first vertical start pulse signal (STV0).
    // The first vertical start pulse signal (STV0) is emitted 6 lines after
    ...
    //
    // On the current configuration, CKV0_CON is 0, thus this register
    // is effective.
    ...
    //
    // Sets CKV0_CON = 0.
    // Do not override the CKV0_DUM configuration.
    //
    // Sets CKV1_CON = 0.
    // Do not override the CKV1_DUM configuration. CKV1 signals (CKV8-CKV11)
    ...
    // BOE TV070WSM-TG1 spec Section 8.0 "Power Sequence" (page 21) states that
    // the interval between the MIPI-DSI initialization code and the high-speed
    // mode should be greater than 120 milliseconds.
    kDsiOpSleep, 120,
    ...
    // DGC_CTRL (Digital Gamma Control Module Control Register) - User page 3, 0x2b-0x2f
    //
    // The digital gamma control (DGC) module maps 8-bit grayscale values to
    // 10-bit grayscale values by linear interpolation.
    //
    // The grayscale pixel values may go through the DGC module before being
    // processed by the analog gamma circuit.
    //
    // JD9364 user guide Section 2.9.3, page 76
    //
    // Sets DGC_EN to true.
    // Enables the digital gamma control (DGC) module.
    kMipiDsiDtGenShortWrite2, 2, 0x2b, 0x01,
    //
    // Sets DGC_SELECT[1:0] to 0b00.
    // The red channel bypasses the DGC module.
    // The green channel is processed by the Digital Gamma Curve 1.
    // The blue channel is processed by the Digital Gamma Curve 2.
    kMipiDsiDtGenShortWrite2, 2, 0x2c, 0x00,

    // SET_DIGITAL_GAMMA1 (Set Gamma Curve 1): User page 3, 0x30-0x63
    //
    // JD9364 user guide Section 2.9.4, pages 77-78.
    //
    // Sets DGC_GAMMA1_V255[9:0] to 0x3cc.
    // Maps 8-bit RGB 255 to 10-bit grayscale value 972.
    kMipiDsiDtGenShortWrite2, 2, 0x30, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x31, 0xcc,
    //
    // Sets DGC_GAMMA1_V254[9:0] to 0x3c9.
    // Maps 8-bit RGB 254 to 10-bit grayscale value 969.
    kMipiDsiDtGenShortWrite2, 2, 0x32, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x33, 0xc9,
    //
    // Sets DGC_GAMMA1_V252[9:0] to 0x3c0.
    // Maps 8-bit RGB 252 to 10-bit grayscale value 960.
    kMipiDsiDtGenShortWrite2, 2, 0x34, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x35, 0xc0,
    //
    // Sets DGC_GAMMA1_V250[9:0] to 0x3b3.
    // Maps 8-bit RGB 250 to 10-bit grayscale value 947.
    kMipiDsiDtGenShortWrite2, 2, 0x36, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x37, 0xb3,
    //
    // Sets DGC_GAMMA1_V248[9:0] to 0x3ab.
    // Maps 8-bit RGB 248 to 10-bit grayscale value 939.
    kMipiDsiDtGenShortWrite2, 2, 0x38, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x39, 0xab,
    //
    // Sets DGC_GAMMA1_V244[9:0] to 0x39d.
    // Maps 8-bit RGB 244 to 10-bit grayscale value 925.
    kMipiDsiDtGenShortWrite2, 2, 0x3a, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x3b, 0x9d,
    //
    // Sets DGC_GAMMA1_V240[9:0] to 0x38f.
    // Maps 8-bit RGB 240 to 10-bit grayscale value 911.
    kMipiDsiDtGenShortWrite2, 2, 0x3c, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x3d, 0x8f,
    //
    // Sets DGC_GAMMA1_V232[9:0] to 0x36d.
    // Maps 8-bit RGB 232 to 10-bit grayscale value 877.
    kMipiDsiDtGenShortWrite2, 2, 0x3e, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x3f, 0x6d,
    //
    // Sets DGC_GAMMA1_V224[9:0] to 0x351.
    // Maps 8-bit RGB 224 to 10-bit grayscale value 849.
    kMipiDsiDtGenShortWrite2, 2, 0x40, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x41, 0x51,
    //
    // Sets DGC_GAMMA1_V208[9:0] to 0x317.
    // Maps 8-bit RGB 208 to 10-bit grayscale value 791.
    kMipiDsiDtGenShortWrite2, 2, 0x42, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x43, 0x17,
    //
    // Sets DGC_GAMMA1_V192[9:0] to 0x2d8.
    // Maps 8-bit RGB 192 to 10-bit grayscale value 728.
    kMipiDsiDtGenShortWrite2, 2, 0x44, 0x02,
    kMipiDsiDtGenShortWrite2, 2, 0x45, 0xd8,
    //
    // Sets DGC_GAMMA1_V160[9:0] to 0x260.
    // Maps 8-bit RGB 160 to 10-bit grayscale value 608.
    kMipiDsiDtGenShortWrite2, 2, 0x46, 0x02,
    kMipiDsiDtGenShortWrite2, 2, 0x47, 0x60,
    //
    // Sets DGC_GAMMA1_V128[9:0] to 0x1eb.
    // Maps 8-bit RGB 128 to 10-bit grayscale value 491.
    kMipiDsiDtGenShortWrite2, 2, 0x48, 0x01,
    kMipiDsiDtGenShortWrite2, 2, 0x49, 0xeb,
    //
    // Sets DGC_GAMMA1_V127[9:0] to 0x1e5.
    // Maps 8-bit RGB 127 to 10-bit grayscale value 485.
    kMipiDsiDtGenShortWrite2, 2, 0x4a, 0x01,
    kMipiDsiDtGenShortWrite2, 2, 0x4b, 0xe5,
    //
    // Sets DGC_GAMMA1_V95[9:0] to 0x16c.
    // Maps 8-bit RGB 95 to 10-bit grayscale value 364.
    kMipiDsiDtGenShortWrite2, 2, 0x4c, 0x01,
    kMipiDsiDtGenShortWrite2, 2, 0x4d, 0x6c,
    //
    // Sets DGC_GAMMA1_V63[9:0] to 0x0f2.
    // Maps 8-bit RGB 63 to 10-bit grayscale value 242.
    kMipiDsiDtGenShortWrite2, 2, 0x4e, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x4f, 0xf2,
    //
    // Sets DGC_GAMMA1_V47[9:0] to 0x0b4.
    // Maps 8-bit RGB 47 to 10-bit grayscale value 180.
    kMipiDsiDtGenShortWrite2, 2, 0x50, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x51, 0xb4,
    //
    // Sets DGC_GAMMA1_V31[9:0] to 0x074.
    // Maps 8-bit RGB 31 to 10-bit grayscale value 116.
    kMipiDsiDtGenShortWrite2, 2, 0x52, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x53, 0x74,
    //
    // Sets DGC_GAMMA1_V23[9:0] to 0x054.
    // Maps 8-bit RGB 23 to 10-bit grayscale value 84.
    kMipiDsiDtGenShortWrite2, 2, 0x54, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x55, 0x54,
    //
    // Sets DGC_GAMMA1_V15[9:0] to 0x034.
    // Maps 8-bit RGB 15 to 10-bit grayscale value 52.
    kMipiDsiDtGenShortWrite2, 2, 0x56, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x57, 0x34,
    //
    // Sets DGC_GAMMA1_V11[9:0] to 0x026.
    // Maps 8-bit RGB 11 to 10-bit grayscale value 38.
    kMipiDsiDtGenShortWrite2, 2, 0x58, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x59, 0x26,
    //
    // Sets DGC_GAMMA1_V7[9:0] to 0x018.
    // Maps 8-bit RGB 7 to 10-bit grayscale value 24.
    kMipiDsiDtGenShortWrite2, 2, 0x5a, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x5b, 0x18,
    //
    // Sets DGC_GAMMA1_V5[9:0] to 0x011.
    // Maps 8-bit RGB 5 to 10-bit grayscale value 17.
    kMipiDsiDtGenShortWrite2, 2, 0x5c, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x5d, 0x11,
    //
    // Sets DGC_GAMMA1_V3[9:0] to 0x00a.
    // Maps 8-bit RGB 3 to 10-bit grayscale value 10.
    kMipiDsiDtGenShortWrite2, 2, 0x5e, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x5f, 0x0a,
    //
    // Sets DGC_GAMMA1_V1[9:0] to 0x003.
    // Maps 8-bit RGB 1 to 10-bit grayscale value 3.
    kMipiDsiDtGenShortWrite2, 2, 0x60, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x61, 0x03,
    //
    // Sets DGC_GAMMA1_V0[9:0] to 0x000.
    // Maps 8-bit RGB 0 to 10-bit grayscale value 0.
    kMipiDsiDtGenShortWrite2, 2, 0x62, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x63, 0x00,


    // SET_DIGITAL_GAMMA2 (Set Gamma Curve 2): User page 3, 0x64-0x97
    //
    // JD9364 user guide Section 2.9.5, pages 79-80.
    //
    // Sets DGC_GAMMA2_V255[9:0] to 0x39e.
    // Maps 8-bit RGB 255 to 10-bit grayscale value 926.
    kMipiDsiDtGenShortWrite2, 2, 0x64, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x65, 0x9e,
    //
    // Sets DGC_GAMMA2_V254[9:0] to 0x39b.
    // Maps 8-bit RGB 254 to 10-bit grayscale value 923.
    kMipiDsiDtGenShortWrite2, 2, 0x66, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x67, 0x9b,
    //
    // Sets DGC_GAMMA2_V252[9:0] to 0x394.
    // Maps 8-bit RGB 252 to 10-bit grayscale value 916.
    kMipiDsiDtGenShortWrite2, 2, 0x68, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x69, 0x94,
    //
    // Sets DGC_GAMMA2_V250[9:0] to 0x38c.
    // Maps 8-bit RGB 250 to 10-bit grayscale value 908.
    kMipiDsiDtGenShortWrite2, 2, 0x6a, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x6b, 0x8c,
    //
    // Sets DGC_GAMMA2_V248[9:0] to 0x385.
    // Maps 8-bit RGB 248 to 10-bit grayscale value 901.
    kMipiDsiDtGenShortWrite2, 2, 0x6c, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x6d, 0x85,
    //
    // Sets DGC_GAMMA2_V244[9:0] to 0x376.
    // Maps 8-bit RGB 244 to 10-bit grayscale value 886.
    kMipiDsiDtGenShortWrite2, 2, 0x6e, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x6f, 0x76,
    //
    // Sets DGC_GAMMA2_V240[9:0] to 0x367.
    // Maps 8-bit RGB 240 to 10-bit grayscale value 871.
    kMipiDsiDtGenShortWrite2, 2, 0x70, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x71, 0x67,
    //
    // Sets DGC_GAMMA2_V232[9:0] to 0x34b.
    // Maps 8-bit RGB 232 to 10-bit grayscale value 843.
    kMipiDsiDtGenShortWrite2, 2, 0x72, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x73, 0x4b,
    //
    // Sets DGC_GAMMA2_V224[9:0] to 0x32e.
    // Maps 8-bit RGB 224 to 10-bit grayscale value 814.
    kMipiDsiDtGenShortWrite2, 2, 0x74, 0x03,
    kMipiDsiDtGenShortWrite2, 2, 0x75, 0x2e,
    //
    // Sets DGC_GAMMA2_V208[9:0] to 0x2f7.
    // Maps 8-bit RGB 208 to 10-bit grayscale value 759.
    kMipiDsiDtGenShortWrite2, 2, 0x76, 0x02,
    kMipiDsiDtGenShortWrite2, 2, 0x77, 0xf7,
    //
    // Sets DGC_GAMMA2_V192[9:0] to 0x2b8.
    // Maps 8-bit RGB 192 to 10-bit grayscale value 696.
    kMipiDsiDtGenShortWrite2, 2, 0x78, 0x02,
    kMipiDsiDtGenShortWrite2, 2, 0x79, 0xb8,
    //
    // Sets DGC_GAMMA2_V160[9:0] to 0x246.
    // Maps 8-bit RGB 160 to 10-bit grayscale value 582.
    kMipiDsiDtGenShortWrite2, 2, 0x7a, 0x02,
    kMipiDsiDtGenShortWrite2, 2, 0x7b, 0x46,
    //
    // Sets DGC_GAMMA2_V128[9:0] to 0x1d6.
    // Maps 8-bit RGB 128 to 10-bit grayscale value 470.
    kMipiDsiDtGenShortWrite2, 2, 0x7c, 0x01,
    kMipiDsiDtGenShortWrite2, 2, 0x7d, 0xd6,
    //
    // Sets DGC_GAMMA2_V127[9:0] to 0x1d0.
    // Maps 8-bit RGB 127 to 10-bit grayscale value 464.
    kMipiDsiDtGenShortWrite2, 2, 0x7e, 0x01,
    kMipiDsiDtGenShortWrite2, 2, 0x7f, 0xd0,
    //
    // Sets DGC_GAMMA2_V95[9:0] to 0x15c.
    // Maps 8-bit RGB 95 to 10-bit grayscale value 348.
    kMipiDsiDtGenShortWrite2, 2, 0x80, 0x01,
    kMipiDsiDtGenShortWrite2, 2, 0x81, 0x5c,
    //
    // Sets DGC_GAMMA2_V63[9:0] to 0x0e7.
    // Maps 8-bit RGB 63 to 10-bit grayscale value 231.
    kMipiDsiDtGenShortWrite2, 2, 0x82, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x83, 0xe7,
    //
    // Sets DGC_GAMMA2_V47[9:0] to 0x0aa.
    // Maps 8-bit RGB 47 to 10-bit grayscale value 170.
    kMipiDsiDtGenShortWrite2, 2, 0x84, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x85, 0xaa,
    //
    // Sets DGC_GAMMA2_V31[9:0] to 0x074.
    // Maps 8-bit RGB 31 to 10-bit grayscale value 116.
    kMipiDsiDtGenShortWrite2, 2, 0x86, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x87, 0x74,
    //
    // Sets DGC_GAMMA2_V23[9:0] to 0x05a.
    // Maps 8-bit RGB 23 to 10-bit grayscale value 90.
    kMipiDsiDtGenShortWrite2, 2, 0x88, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x89, 0x5a,
    //
    // Sets DGC_GAMMA2_V15[9:0] to 0x03c.
    // Maps 8-bit RGB 15 to 10-bit grayscale value 60.
    kMipiDsiDtGenShortWrite2, 2, 0x8a, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x8b, 0x3c,
    //
    // Sets DGC_GAMMA2_V11[9:0] to 0x02c.
    // Maps 8-bit RGB 11 to 10-bit grayscale value 44.
    kMipiDsiDtGenShortWrite2, 2, 0x8c, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x8d, 0x2c,
    //
    // Sets DGC_GAMMA2_V7[9:0] to 0x01c.
    // Maps 8-bit RGB 7 to 10-bit grayscale value 28.
    kMipiDsiDtGenShortWrite2, 2, 0x8e, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x8f, 0x1c,
    //
    // Sets DGC_GAMMA2_V5[9:0] to 0x014.
    // Maps 8-bit RGB 5 to 10-bit grayscale value 20.
    kMipiDsiDtGenShortWrite2, 2, 0x90, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x91, 0x14,
    //
    // Sets DGC_GAMMA2_V3[9:0] to 0x00c.
    // Maps 8-bit RGB 3 to 10-bit grayscale value 12.
    kMipiDsiDtGenShortWrite2, 2, 0x92, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x93, 0x0c,
    //
    // Sets DGC_GAMMA2_V1[9:0] to 0x004.
    // Maps 8-bit RGB 1 to 10-bit grayscale value 4.
    kMipiDsiDtGenShortWrite2, 2, 0x94, 0x00,
    kMipiDsiDtGenShortWrite2, 2, 0x95, 0x04,
    //
    // Sets DGC_GAMMA2_V0[9:0] to 0x000.
    // Maps 8-bit RGB 0 to 10-bit grayscale value 0.
...
#endif  // SRC_GRAPHICS_DISPLAY_DRIVERS_AMLOGIC_DISPLAY_PANEL_BOE_TV070WSM_FITIPOWER_JD9364_ASTRO_H_
