...
//
// TODO(https://fxbug.dev/42158168): implement a bidirectional map that can
// support looking up key to value as well as value to key (two map solution is
// probably good enough). Makes this clearer, easier to maintain, etc.
