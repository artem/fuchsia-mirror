...
pub(crate) struct GmpStateRef<'a, I: IpExt, CC: GmpTypeLayout<I, BT>, BT: GmpBindingsTypes> {
    pub(crate) enabled: bool,
    pub(crate) groups: &'a mut MulticastGroupSet<I::Addr, CC::GroupState>,
    pub(crate) gmp: &'a mut GmpState<I, BT>,
}
