...
#ifndef SRC_BRINGUP_BIN_CRITICAL_SERVICES_CRASHSVC_LOGGING_H_
#define SRC_BRINGUP_BIN_CRITICAL_SERVICES_CRASHSVC_LOGGING_H_
...
#endif  // SRC_BRINGUP_BIN_CRITICAL_SERVICES_CRASHSVC_LOGGING_H_
