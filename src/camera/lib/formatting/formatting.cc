...
ENUM_BEGIN(fuchsia::images2, ColorSpace)
ENUM_ELEMENT(ColorSpace::INVALID)
ENUM_ELEMENT(ColorSpace::SRGB)
ENUM_ELEMENT(ColorSpace::REC601_NTSC)
ENUM_ELEMENT(ColorSpace::REC601_NTSC_FULL_RANGE)
ENUM_ELEMENT(ColorSpace::REC601_PAL)
ENUM_ELEMENT(ColorSpace::REC601_PAL_FULL_RANGE)
ENUM_ELEMENT(ColorSpace::REC709)
ENUM_ELEMENT(ColorSpace::REC2020)
ENUM_ELEMENT(ColorSpace::REC2100)
ENUM_ELEMENT(ColorSpace::PASSTHROUGH)
ENUM_ELEMENT(ColorSpace::DO_NOT_CARE)
ENUM_FLEXIBLE_END()
...
TABLE_BEGIN(fuchsia::sysmem2, BufferUsage)
TABLE_ELEMENT(none)
TABLE_ELEMENT(cpu)
TABLE_ELEMENT(vulkan)
TABLE_ELEMENT(display)
TABLE_ELEMENT(video)
TABLE_END()
...
TABLE_BEGIN(fuchsia::sysmem2, Heap)
TABLE_ELEMENT(heap_type)
TABLE_ELEMENT(id)
TABLE_END()
...
STRUCT_BEGIN(fuchsia::math, SizeU)
STRUCT_ELEMENT(width)
STRUCT_ELEMENT(height)
STRUCT_END()

STRUCT_BEGIN(fuchsia::math, RectU)
STRUCT_ELEMENT(x)
STRUCT_ELEMENT(y)
STRUCT_ELEMENT(width)
STRUCT_ELEMENT(height)
...
TABLE_BEGIN(fuchsia::sysmem2, ImageFormatConstraints)
TABLE_ELEMENT(pixel_format)
TABLE_ELEMENT(color_spaces)
TABLE_ELEMENT(min_size)
TABLE_ELEMENT(max_size)
TABLE_ELEMENT(max_bytes_per_row)
TABLE_ELEMENT(max_width_times_height)
TABLE_ELEMENT(size_alignment)
TABLE_ELEMENT(bytes_per_row_divisor)
TABLE_ELEMENT(start_offset_divisor)
TABLE_ELEMENT(display_rect_alignment)
TABLE_ELEMENT(required_min_size)
TABLE_ELEMENT(required_max_size)
TABLE_END()
...
TABLE_BEGIN(fuchsia::images2, ImageFormat)
TABLE_ELEMENT(pixel_format)
TABLE_ELEMENT(size)
TABLE_ELEMENT(bytes_per_row)
TABLE_ELEMENT(display_rect)
TABLE_ELEMENT(color_space)
TABLE_ELEMENT(pixel_aspect_ratio)
TABLE_END()
...
TABLE_BEGIN(fuchsia::sysmem2, BufferMemoryConstraints)
TABLE_ELEMENT(min_size_bytes)
TABLE_ELEMENT(max_size_bytes)
TABLE_ELEMENT(physically_contiguous_required)
TABLE_ELEMENT(secure_required)
TABLE_ELEMENT(ram_domain_supported)
TABLE_ELEMENT(cpu_domain_supported)
TABLE_ELEMENT(inaccessible_domain_supported)
TABLE_ELEMENT(permitted_heaps)
TABLE_END()
...
TABLE_BEGIN(fuchsia::sysmem2, BufferCollectionConstraints)
TABLE_ELEMENT(usage)
TABLE_ELEMENT(min_buffer_count_for_camping)
TABLE_ELEMENT(min_buffer_count_for_dedicated_slack)
TABLE_ELEMENT(min_buffer_count_for_shared_slack)
TABLE_ELEMENT(min_buffer_count)
TABLE_ELEMENT(max_buffer_count)
TABLE_ELEMENT(buffer_memory_constraints)
TABLE_ELEMENT(image_format_constraints)
TABLE_END()
